                        ...
                        <div className="table-responsive shop_cart_table">
                            <table className="table">
                                ...
                                <tr>
                                    ...
                                    <td className="product-quantity" data-title="Quantity"><div className="quantity">
                                        <input type="button" value="-" className="minus" />
                                            <input type="text" name="quantity" value="2" title="Qty" className="qty" size={4} />
                                                <input type="button" value="+" className="plus" />
                                    </div></td>
                                    <td className="product-subtotal" data-title="Total">$90.00</td>
                                ...
                                <tr>
                                    ...
                                    <td className="product-subtotal" data-title="Total">$55.00</td>
                                    <td className="product-remove" data-title="Remove"><a href="#"><i className="ti-close"></i></a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="product-quantity" data-title="Quantity">
                                        ...
                                        <input type="button" value="-" className="minus" />
                                            <input type="text" name="quantity" value="3" title="Qty" className="qty" size={4} />
                                                <input type="button" value="+" className="plus" />
                                    </div>
                                    </td>
                                    <td className="product-subtotal" data-title="Total">$204.00</td>
                                    <td className="product-remove" data-title="Remove"><a href="#"><i className="ti-close"></i></a></td>
                                </tr>
                                </tbody>
                                <tfoot>
                        ...
                        <form className="field_form shipping_calculator">
                            ...
                            <div className="form-row">
                                <div className="form-group col-lg-6">
                                    <input placeholder="State / Country" className="form-control" name="name" type="text" />
                                </div>
                                <div className="form-group col-lg-6">
                                    <input placeholder="PostCode / ZIP" className="form-control" name="name" type="text" />
                                </div>
                            </div>
                            <div className="form-row">
                                <div className="form-group col-lg-12">
                            ...
                            <div className="table-responsive">
                                <table className="table">
                                    ...
                                    <tr>
                                        ...
                                        <td className="cart_total_amount"><strong>$349.00</strong></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>

                                ...
                                <div className="product_header">
                                    ...
                                    <div className="product_header_right">
                                        <div className="products_view">
                                            <a href="javascript:Void(0);" className="shorting_icon grid"><i className="ti-view-grid"></i></a>
                                            <a href="javascript:Void(0);" className="shorting_icon list active"><i className="ti-layout-list-thumb"></i></a>
                                        </div>
                                        <div className="custom_select">
                                            <select className="form-control form-control-sm">
                                ...
                                <ul className="list_brand">
                                    <li>
                                        <div className="custome-checkbox">
                                            <input className="form-check-input" type="checkbox" name="checkbox" id="Arrivals" />

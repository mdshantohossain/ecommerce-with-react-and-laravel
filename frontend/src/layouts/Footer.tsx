...
const Footer = () => {
    ...
    return(
        <>
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-6 col-sm-12">
                                <div className="widget">
                                    ...
                                    <p>If you are going to use of Lorem Ipsum need to be sure there isn't hidden of
                                        text</p>
                                </div>
                                <div className="widget">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6">
                                <p className="mb-md-0 text-center text-md-left">© 2020 All Rights Reserved by
                                    Bestwebcreator</p>
                            </div>
                            <div className="col-md-6">
            ...
            <a href="#" className="scrollup d-none"><i className="ion-ios-arrow-up"></i></a>
        </>
    )
